...
test('sidepanel html exposes flow selector and kiro source fields', () => {
  ...
  [
    ...
    'id="row-grok2api-admin-password"',
    'id="btn-toggle-grok2api-admin-password"',
    ...
    'id="row-claude2api-url"',
    'id="input-claude2api-url"',
    'id="row-claude2api-password"',
    'id="input-claude2api-password"',
    'id="btn-test-claude2api"',
    'id="row-claude2api-test-status"',
    'id="display-claude2api-test-status"',
