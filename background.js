...
const stepExecutorsByKey = {
  ...
  'claude-submit-email-and-fetch-link': (state) => claudeRegisterRunner.executeClaudeSubmitEmailAndFetchLink(state),
  'claude-open-login-link': (state) => claudeRegisterRunner.executeClaudeOpenLoginLink(state),
  'claude-create-account': (state) => claudeRegisterRunner.executeClaudeCreateAccount(state),
  'claude-select-free-plan': (state) => claudeRegisterRunner.executeClaudeSelectFreePlan(state),
  'claude-skip-onboarding': (state) => claudeRegisterRunner.executeClaudeSkipOnboarding(state),
  'claude-continue-onboarding': (state) => claudeRegisterRunner.executeClaudeContinueOnboarding(state),
  'claude-submit-random-name': (state) => claudeRegisterRunner.executeClaudeSubmitRandomName(state),
  'claude-set-up-later': (state) => claudeRegisterRunner.executeClaudeSetUpLater(state),
  'claude-extract-session-key': (state) => claudeRegisterRunner.executeClaudeExtractSessionKey(state),
};
